...
public class FindCorrectBranchFromPos {
  ...
  public static BranchPositions UnitTest1() {
    double x = -4.1902085050000 / 3.8337244850000 * SPECIAL_X + Constants.LIMELIGHT_HALF_POS.getX();
    double y = -0.706978325 / 3.8337244850000 * SPECIAL_Y + Constants.LIMELIGHT_HALF_POS.getY();
    return FindCoralBranch(new Pose2d(0, 0, new Rotation2d(0)), new Translation2d(x, y));
  }
