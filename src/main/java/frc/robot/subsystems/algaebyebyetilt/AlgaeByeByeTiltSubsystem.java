...
public class AlgaeByeByeTiltSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartShuffleboard.put("AlgaeByeByeTilt", "Angle", getAngle());
    SmartShuffleboard.put("AlgaeByeByeTilt", "FwdSwitch", getForwardSwitchState());
    SmartShuffleboard.put("AlgaeByeByeTilt", "RevSwitch", getReverseSwitchState());
  }
