...
public enum Apriltag {
  ...
  // ELEVEN(Units.inchesToMeters(468.69), Units.inchesToMeters(146.19),
  // Units.inchesToMeters(52.00)),
  // TWELVE(Units.inchesToMeters(468.69), Units.inchesToMeters(177.10),
  // Units.inchesToMeters(52.00)),
  // THIRTEEN(Units.inchesToMeters(441.74), Units.inchesToMeters(161.62),
  // Units.inchesToMeters(52.00)),
  // FOURTEEN(Units.inchesToMeters(209.48), Units.inchesToMeters(161.62),
  // Units.inchesToMeters(52.00)),
  // FIFTEEN(Units.inchesToMeters(182.73), Units.inchesToMeters(177.10),
  // Units.inchesToMeters(52.00)),
  // SIXTEEN(Units.inchesToMeters(182.73), Units.inchesToMeters(146.19),
  // Units.inchesToMeters(52.00));
