...
/**
 * A diagnostics class for digital encoder that is connected directly to the Talon SRX. The
 * diagnostics will turn green once the encoder has traveled at least a given distance from its
 * initial position (measured at initialization or after a reset)
 */
public class DiagTalonSrxEncoder extends DiagDistanceTraveled {
  ...
  */
  public DiagTalonSrxEncoder(
      String title, String name, double requiredTravel, WPI_TalonSRX talonSRX) {
    super(title, name, requiredTravel);
